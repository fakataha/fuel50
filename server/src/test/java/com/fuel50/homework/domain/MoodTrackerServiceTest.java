...
class MoodTrackerServiceTest {
    ...
    void testGetCurrent() {
        ...
        Mockito.when(moodTrackerRepository.findAllWithCreationDateTimeAfter(Mockito.any())).thenReturn(moodRecords);
        ...
        Assertions.assertThat(capturedDateTime.truncatedTo(ChronoUnit.HOURS)).isEqualTo(expected.truncatedTo(ChronoUnit.HOURS));
    }
