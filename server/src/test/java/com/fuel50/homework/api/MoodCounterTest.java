...
class MoodCounterTest {
    ...
    private List<MoodRecord> getMoodRecords() {
        ...
        MoodRecord happy = MoodRecord.builder()
                .setMood(Mood.HAPPY)
                .build();
        ...
        MoodRecord grumpy = MoodRecord.builder()
                .setMood(Mood.GRUMPY)
                .build();
        ...
        MoodRecord meh = MoodRecord.builder()
                .setMood(Mood.A_BIT_MEH)
                .build();
        moodRecords.add(meh);
        moodRecords.add(meh);
        moodRecords.add(meh);

        MoodRecord normal = MoodRecord.builder()
                .setMood(Mood.JUST_NORMAL_REALLY)
                .build();
        moodRecords.add(normal);
        moodRecords.add(normal);

        MoodRecord stressed = MoodRecord.builder()
                .setMood(Mood.STRESSED_OUT_NOT_A_HAPPY_CAMPER)
                .build();
