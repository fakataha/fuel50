...
class MainControllerTest {
  ...
  @Mock private MoodTrackerService moodTrackerService;
  ...
  @Test
  @DisplayName("1 or fewer records found.")
  void testFewRecords() {
    List<MoodRecord> moodRecords = new ArrayList<>();
    Mockito.when(moodTrackerService.getAllMoodRecords()).thenReturn(moodRecords);
  ...
  void testSummary() {
    ...
    Mockito.when(moodCounter.apply(Mockito.any(), Mockito.any())).thenReturn(999, 2, 5, 7, 3);
